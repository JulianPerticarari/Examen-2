// 4) Encontrar los errores en el código que paso adjunto, 
...
// this.edad = edad; 
// } 
// mostrarInformacion() { // Error: nombre del método 
// debería ser mostrarInfo 
// console.log(`Nombre: ${nombre}, Tipo: ${tipo}, 
// Edad: ${edad}`); // Error: las propiedades no están 
// referenciadas correctamente 
// } 
// } 
...
// this.mascota.push(mascota); // Error: this.mascota 
// debería ser this.mascotas 
// } 
// mostrarMascotas() { 
// this.mascotas.forEach(mascota => 
// mascota.mostrarInformacion()); // Error: 
// mostrarInformacion() mal escrito, debería ser 
// mostrarInfo() 
// } 
// } 
// // Ejemplo de uso 
...
// // Se esperan errores debido a los problemas 
...
const mascota1 = new Mascota('Firulais', 'Perro', 7);
const mascota2 = new Mascota('Mafia', 'Gato', 2);
const mascota3 = new Mascota('Skipps', 'Gorila', 5);
const miTienda = new TiendaDeMascotas();
miTienda.añadirMascota(mascota1);
miTienda.añadirMascota(mascota2);
miTienda.añadirMascota(mascota3);
